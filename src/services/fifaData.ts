...
export const EA_FC_DATABASE: FIFAClubData[] = [
  // --- LALIGA EA SPORTS (TODOS LOS EQUIPOS REALES) ---
  {
    name: 'Real Madrid',
  ...
  },
  {
    ...
    squad: [
      ...
      { name: 'Raphinha', age: 27, overall: 84, potential: 87, position: 'DEL', specificPosition: 'EI', marketValue: 60000000, country: 'Brasil', attributes: { pace: 90, shooting: 82, passing: 81, dribbling: 85, defending: 50, physical: 73 } },
  ...
  },
  {
    ...
    pattern: 'stripes',
    squad: [
      { name: 'Viktor Tsygankov', age: 26, overall: 82, potential: 84, position: 'DEL', specificPosition: 'ED', marketValue: 30000000, country: 'Ucrania', attributes: { pace: 84, shooting: 78, passing: 80, dribbling: 82, defending: 45, physical: 68 } },
      { name: 'Yaser Asprilla', age: 20, overall: 76, potential: 85, position: 'MED', specificPosition: 'MCO', marketValue: 18000000, country: 'Colombia', attributes: { pace: 86, shooting: 74, passing: 76, dribbling: 82, defending: 38, physical: 65 } },
      { name: 'Daley Blind', age: 34, overall: 79, potential: 79, position: 'DEF', specificPosition: 'DFC', marketValue: 3000000, country: 'Países Bajos', attributes: { pace: 58, shooting: 65, passing: 84, dribbling: 75, defending: 80, physical: 70 } },
      { name: 'Oriol Romeu', age: 32, overall: 78, potential: 78, position: 'MED', specificPosition: 'MCD', marketValue: 3000000, country: 'España', attributes: { pace: 55, shooting: 60, passing: 76, dribbling: 70, defending: 79, physical: 82 } },
      { name: 'Abel Ruiz', age: 24, overall: 76, potential: 81, position: 'DEL', specificPosition: 'DC', marketValue: 12000000, country: 'España', attributes: { pace: 78, shooting: 76, passing: 70, dribbling: 75, defending: 35, physical: 74 } },
      { name: 'Paulo Gazzaniga', age: 32, overall: 78, potential: 78, position: 'POR', specificPosition: 'POR', marketValue: 4000000, country: 'Argentina', attributes: { pace: 45, shooting: 20, passing: 68, dribbling: 40, defending: 78, physical: 76 } },
      { name: 'Miguel Gutiérrez', age: 23, overall: 81, potential: 86, position: 'DEF', specificPosition: 'LI', marketValue: 25000000, country: 'España', attributes: { pace: 85, shooting: 68, passing: 80, dribbling: 80, defending: 76, physical: 72 } }
    ]
  },
  {
    name: 'Real Sociedad',
    ...
    pattern: 'stripes',
    squad: [
      { name: 'Takefusa Kubo', age: 23, overall: 82, potential: 87, position: 'DEL', specificPosition: 'ED', marketValue: 50000000, country: 'Japón', attributes: { pace: 88, shooting: 76, passing: 80, dribbling: 86, defending: 40, physical: 60 } },
      { name: 'Mikel Oyarzabal', age: 27, overall: 82, potential: 83, position: 'DEL', specificPosition: 'EI', marketValue: 40000000, country: 'España', attributes: { pace: 78, shooting: 82, passing: 80, dribbling: 82, defending: 50, physical: 74 } },
      { name: 'Martin Zubimendi', age: 25, overall: 83, potential: 87, position: 'MED', specificPosition: 'MCD', marketValue: 60000000, country: 'España', attributes: { pace: 72, shooting: 68, passing: 82, dribbling: 79, defending: 83, physical: 78 } },
      { name: 'Alex Remiro', age: 29, overall: 83, potential: 84, position: 'POR', specificPosition: 'POR', marketValue: 25000000, country: 'España', attributes: { pace: 45, shooting: 20, passing: 70, dribbling: 40, defending: 83, physical: 76 } },
      { name: 'Brais Méndez', age: 27, overall: 81, potential: 82, position: 'MED', specificPosition: 'MCO', marketValue: 35000000, country: 'España', attributes: { pace: 74, shooting: 78, passing: 82, dribbling: 82, defending: 60, physical: 70 } }
    ]
  },
  {
    name: 'Real Betis',
    ...
    pattern: 'stripes',
    squad: [
      { name: 'Isco Alarcón', age: 32, overall: 83, potential: 83, position: 'MED', specificPosition: 'MCO', marketValue: 10000000, country: 'España', attributes: { pace: 70, shooting: 80, passing: 86, dribbling: 88, defending: 55, physical: 65 } },
      { name: 'Giovani Lo Celso', age: 28, overall: 81, potential: 81, position: 'MED', specificPosition: 'MC', marketValue: 20000000, country: 'Argentina', attributes: { pace: 76, shooting: 78, passing: 83, dribbling: 84, defending: 62, physical: 70 } },
      { name: 'Vitor Roque', age: 19, overall: 76, potential: 86, position: 'DEL', specificPosition: 'DC', marketValue: 30000000, country: 'Brasil', attributes: { pace: 86, shooting: 76, passing: 65, dribbling: 78, defending: 35, physical: 75 } },
      { name: 'Pablo Fornals', age: 28, overall: 79, potential: 79, position: 'MED', specificPosition: 'MI', marketValue: 15000000, country: 'España', attributes: { pace: 74, shooting: 74, passing: 80, dribbling: 79, defending: 65, physical: 72 } }
    ]
  },
  {
    name: 'Villarreal CF',
    ...
    pattern: 'solid',
    squad: [
      { name: 'Gerard Moreno', age: 32, overall: 83, potential: 83, position: 'DEL', specificPosition: 'DC', marketValue: 12000000, country: 'España', attributes: { pace: 76, shooting: 85, passing: 81, dribbling: 83, defending: 45, physical: 72 } },
      { name: 'Álex Baena', age: 23, overall: 82, potential: 87, position: 'MED', specificPosition: 'MCO', marketValue: 50000000, country: 'España', attributes: { pace: 78, shooting: 78, passing: 85, dribbling: 83, defending: 60, physical: 74 } },
      { name: 'Ayoze Pérez', age: 31, overall: 80, potential: 80, position: 'DEL', specificPosition: 'EI', marketValue: 10000000, country: 'España', attributes: { pace: 80, shooting: 79, passing: 76, dribbling: 81, defending: 42, physical: 68 } },
      { name: 'Yeremy Pino', age: 21, overall: 79, potential: 85, position: 'DEL', specificPosition: 'ED', marketValue: 30000000, country: 'España', attributes: { pace: 84, shooting: 76, passing: 76, dribbling: 82, defending: 45, physical: 65 } }
    ]
  },
  {
    name: 'Valencia CF',
    ...
    pattern: 'solid',
    squad: [
      { name: 'Mamardashvili', age: 23, overall: 84, potential: 88, position: 'POR', specificPosition: 'POR', marketValue: 45000000, country: 'Georgia', attributes: { pace: 45, shooting: 20, passing: 65, dribbling: 40, defending: 85, physical: 80 } },
      { name: 'José Luis Gayà', age: 29, overall: 81, potential: 81, position: 'DEF', specificPosition: 'LI', marketValue: 20000000, country: 'España', attributes: { pace: 84, shooting: 64, passing: 78, dribbling: 78, defending: 78, physical: 72 } },
      { name: 'Hugo Duro', age: 24, overall: 78, potential: 82, position: 'DEL', specificPosition: 'DC', marketValue: 16000000, country: 'España', attributes: { pace: 78, shooting: 80, passing: 68, dribbling: 74, defending: 42, physical: 78 } },
      { name: 'Javi Guerra', age: 21, overall: 77, potential: 85, position: 'MED', specificPosition: 'MC', marketValue: 25000000, country: 'España', attributes: { pace: 78, shooting: 72, passing: 78, dribbling: 80, defending: 72, physical: 76 } }
    ]
  },

  // --- PREMIER LEAGUE (EQUIPOS PRINCIPALES) ---
  {
